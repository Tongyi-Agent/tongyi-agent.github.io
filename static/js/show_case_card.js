      ...
      leftPanel.innerHTML = `
        ...
        <div class="command-block">
          <div class="command-header">
            ...
            <span class="command-text">Initial Query: What is the average number of stars per constellation in a random geometric graph where each star is joined by an edge to its nearest neighbor?</span>
          </div>
        </div>
      `;
      // 重新插入初始化动画
